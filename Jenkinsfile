    ...
    stages {
        ...
        stage("test"){
            ...
            post {
                ...
                success{
                    slackSend (color: '#008000', message: "Job '${env.JOB_NAME}, Build nr. [${env.BUILD_NUMBER}]', Result: SUCCEEDED -> (http://dev-jenkins.duckdns.org:8081/job/${env.JOB_NAME}/${env.BUILD_NUMBER}/)")
                }
                unstable{
